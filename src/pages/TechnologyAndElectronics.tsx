...
import styles from "./TechnologyAndElectronics.module.css";

const TechnologyAndElectronics: FunctionComponent = () => {
  return (
    <div className={styles.technologyAndElectronics}>
      <Heder
        frameWidth="1205px"
        frameOverflow="unset"
        frameAlignSelf="unset"
        vector="/vector17@2x.png"
        vector1="/vector18@2x.png"
        image="/image6@2x.png"
      ...
      <Ad
        ...
        sellingOnlineWithAnEcommeWidth="1207px"
        sellingOnlineWithAnEcommeBackgroundImage="url('/sellingonlinewithanecommercestore-15@3x.png')"
...
export default TechnologyAndElectronics;
