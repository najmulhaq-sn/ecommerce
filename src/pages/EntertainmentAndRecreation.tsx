...
import styles from "./EntertainmentAndRecreation.module.css";

const EntertainmentAndRecreation: FunctionComponent = () => {
  return (
    <div className={styles.entertainmentAndRecreation}>
      <Header1
