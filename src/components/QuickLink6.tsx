...
import styles from "./QuickLink6.module.css";

export type QuickLink6Type = {
  className?: string;
};

const QuickLink6: FunctionComponent<QuickLink6Type> = ({ className = "" }) => {
  return (
    <section className={[styles.foodAndDiningInner, className].join(" ")}>
